...
folder_name = f'../Figures/Results/LSTM/{forecast_periods} months'
...
for maturity in maturities:
    ...
    # Build a recurrent neural network (LSTM) model
    ...
    if forecast_periods > 3:
        ...
        plt.plot(test_dates, y_pred, label='LSTM Forecast', linestyle='--', marker='o', color="C0")
...
plt.figure(figsize=(10, 6))
plt.plot(predicted_df.columns, predicted_df.loc[last_date], marker='o', label=f'LSTM Forecasted Yield Curve on {last_date}', color='C0')
